...
PROFILE_KEYS = {"schema_version", "kind", "name", "source", "environment", "resources", "agent", "execution", "safety"}
SECTION_KEYS = {
    ...
    "resources": {
        "data_files", "context_paths", "skills", "readonly_assets",
...
def load_and_resolve(
    ...
    *,
    ...
    if raw.get("schema_version") == 1 or raw.get("kind") in {"task", "project_profile"}:
