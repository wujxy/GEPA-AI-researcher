...
本文档用于指导 GEPA 从当前 v1.0 基础 loop 演进到 v2.0 agentic architecture。
...
## 4. v1.1: Reliable Loop Kernel

### 4.1 版本目标

v1.1 不增加新的 agent 智能，不正式引入 Planner 和 Critic。
...
### 5.6 Role-specific Context Views
...
### 9.2 风险：Context Manager 变成新 Agent
...
### 9.5 风险：Executor 自由度过高导致 proposal 漂移
